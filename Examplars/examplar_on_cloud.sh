...
python3 brew_poison.py  --recipe bullseye --net ResNet18 --vruns 1 --attackiter 200 --poisonkey 1000000000 --budget 0.01 --restarts 1 --pbatch 512 --ensemble 1 --name ablation_no_aug_no_aug --save limited --pretrained
# Fail
